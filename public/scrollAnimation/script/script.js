...
function transformScroll(frameID, element, minSize, maxSize, decrementer, direction, transform, unit, minSize1, maxSize1, decrementer1, direction1, transform1, unit1, minSize2, maxSize2, decrementer2, direction2, transform2, unit2, minSize3, maxSize3, decrementer3, direction3, transform3, unit3, minSize4, maxSize4, decrementer4, direction4, transform4, unit4, minSize5, maxSize5, decrementer5, direction5, transform5, unit5) {
  ...
  if (direction == "forwards" || direction == undefined) {
    if (isScrolledIntoView(container, section)) {
      transformHold = transformVar + "(" + (Math.max(Math.min(Math.round(((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((maxSize - minSize) / 20 + .16)), maxSize), minSize) / decrementer) + unitVar + ")";
    } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
    ...
    if (isScrolledIntoView(container, section)) {
      transformHold = transformVar + "(" + (Math.max(Math.min(Math.round(minSize - ((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((minSize - maxSize) / 20 + .16)), minSize), maxSize) / decrementer) + unitVar + ")";
    } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
      transformHold = transformVar + "(" + (minSize / decrementer) + unitVar + ")"
    } else if (!isScrolledIntoView(container, section) && elemTop <= 0) {
  ...
  if (transform1 != undefined) {
    if (direction1 == "forwards" || direction1 == undefined) {
      if (isScrolledIntoView(container, section)) {
        transformHold1 = transformVar1 + "(" + (Math.max(Math.min(Math.round(((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((maxSize1 - minSize1) / 20 + .16)), maxSize1), minSize1) / decrementer1) + unitVar1 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
      ...
      if (isScrolledIntoView(container, section)) {
        transformHold1 = transformVar1 + "(" + (Math.max(Math.min(Math.round(minSize1 - ((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((minSize1 - maxSize1) / 20 + .16)), minSize1), maxSize1) / decrementer1) + unitVar1 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
        transformHold1 = transformVar1 + "(" + (minSize1 / decrementer1) + unitVar1 + ")"
      } else if (!isScrolledIntoView(container, section) && elemTop <= 0) {
        transformHold1 = transformVar1 + "(" + (maxSize1 / decrementer1) + unitVar1 + ")"
  ...
  if (transform2 != undefined) {
    if (direction2 == "forwards" || direction2 == undefined) {
      if (isScrolledIntoView(container, section)) {
        transformHold2 = transformVar2 + "(" + (Math.max(Math.min(Math.round(((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((maxSize2 - minSize2) / 20 + .16)), maxSize2), minSize2) / decrementer2) + unitVar2 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
      ...
      if (isScrolledIntoView(container, section)) {
        transformHold2 = transformVar2 + "(" + (Math.max(Math.min(Math.round(minSize2 - ((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((minSize2 - maxSize2) / 20 + .16)), minSize2), maxSize2) / decrementer2) + unitVar2 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
        transformHold2 = transformVar2 + "(" + (minSize2 / decrementer2) + unitVar2 + ")"
      } else if (!isScrolledIntoView(container, section) && elemTop <= 0) {
        transformHold2 = transformVar2 + "(" + (maxSize2 / decrementer2) + unitVar2 + ")"
  ...
  if (transform3 != undefined) {
    if (direction3 == "forwards" || direction3 == undefined) {
      if (isScrolledIntoView(container, section)) {
        transformHold3 = transformVar3 + "(" + (Math.max(Math.min(Math.round(((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((maxSize3 - minSize3) / 20 + .16)), maxSize3), minSize3) / decrementer3) + unitVar3 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
      ...
      if (isScrolledIntoView(container, section)) {
        transformHold3 = transformVar3 + "(" + (Math.max(Math.min(Math.round(minSize3 - ((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((minSize3 - maxSize3) / 20 + .16)), minSize3), maxSize3) / decrementer3) + unitVar3 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
        transformHold3 = transformVar3 + "(" + (minSize3 / decrementer3) + unitVar3 + ")"
      } else if (!isScrolledIntoView(container, section) && elemTop <= 0) {
        transformHold3 = transformVar3 + "(" + (maxSize3 / decrementer3) + unitVar3 + ")"
  ...
  if (transform4 != undefined) {
    if (direction4 == "forwards" || direction4 == undefined) {
      if (isScrolledIntoView(container, section)) {
        transformHold4 = transformVar4 + "(" + (Math.max(Math.min(Math.round(((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((maxSize4 - minSize4) / 20 + .16)), maxSize4), minSize4) / decrementer4) + unitVar4 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
      ...
      if (isScrolledIntoView(container, section)) {
        transformHold4 = transformVar4 + "(" + (Math.max(Math.min(Math.round(minSize4 - ((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((minSize4 - maxSize4) / 20 + .16)), minSize4), maxSize4) / decrementer4) + unitVar4 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
        transformHold4 = transformVar4 + "(" + (minSize4 / decrementer4) + unitVar4 + ")"
      } else if (!isScrolledIntoView(container, section) && elemTop <= 0) {
        transformHold4 = transformVar4 + "(" + (maxSize4 / decrementer4) + unitVar4 + ")"
  ...
  if (transform5 != undefined) {
    if (direction5 == "forwards" || direction5 == undefined) {
      if (isScrolledIntoView(container, section)) {
        transformHold5 = transformVar5 + "(" + (Math.max(Math.min(Math.round(((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((maxSize5 - minSize5) / 20 + .16)), maxSize5), minSize5) / decrementer5) + unitVar5 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
      ...
      if (isScrolledIntoView(container, section)) {
        transformHold5 = transformVar5 + "(" + (Math.max(Math.min(Math.round(minSize5 - ((document.documentElement.scrollTop - (elemTop + window.pageYOffset)) * 1) / rect.height * 100 * ((minSize5 - maxSize5) / 20 + .16)), minSize5), maxSize5) / decrementer5) + unitVar5 + ")";
      } else if (!isScrolledIntoView(container, section) && elemTop >= 0) {
        transformHold5 = transformVar5 + "(" + (minSize5 / decrementer5) + unitVar5 + ")"
      } else if (!isScrolledIntoView(container, section) && elemTop <= 0) {
        transformHold5 = transformVar5 + "(" + (maxSize5 / decrementer5) + unitVar5 + ")"
